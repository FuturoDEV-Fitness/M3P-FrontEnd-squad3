...
function NovoUsuario(){
    ...
    async function formRegister(formValue){
        let dataForm = {
            ...
            endereco: `${formValue.cep}, ${formValue.ruaUsuario}, ${formValue.bairroUsuario}, ${formValue.numeroUsuario}, ${formValue.complementoUsuario}, ${formValue.cidadeUsuario}, ${formValue.estadoUsuario}`,
