...
function NewLocation() {
  ...
  async function formRegister(formValue) {
    ...
    let dataForm = {
      ...
      itens_checkbox: stringAtividade,
  ...
  return (
    <div>
      ...
      <div className={styles.containerCadastroLugar}>
        ...
        <form
          className={styles.formCadastroLugar}
        ...
        >
          ...
          <textarea
            type="text"
            placeholder="Descreva brevemente o lugar e a atividade física que pode ser praticada nesse local."
            name="descricao"
            {...register("descricao")}
          ></textarea>
          {errors?.descricao && (
          ...
          <p className={styles.pForm}>Tipos de atividade física</p>
